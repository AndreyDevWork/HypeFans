...
gulp.task('filestructures', function (done) {
    fs.mkdirSync('./src');
    fs.mkdirSync('./src/css');
    fs.mkdirSync('./src/fonts');
    fs.mkdirSync('./src/fonts/icons_font');
    fs.mkdirSync('./src/icons');
    fs.mkdirSync('./src/img');
    fs.mkdirSync('./src/img/bg');
    fs.mkdirSync('./src/js');
    fs.mkdirSync('./src/sass');
    fs.mkdirSync('./src/sass/base');
    fs.mkdirSync('./src/sass/libs');
    fs.mkdirSync('./src/sass/blocks');
    fs.mkdirSync('./src/php');
    fs.writeFileSync('./src/index.html', '');
    
    fs.mkdirSync('./dist');
    fs.mkdirSync('./dist/php');
    fs.mkdirSync('./dist/css');
    fs.mkdirSync('./dist/fonts');
    fs.mkdirSync('./dist/icons');
    fs.mkdirSync('./dist/fonts/icons_font');
    fs.mkdirSync('./dist/img');
    fs.mkdirSync('./dist/img/bg');
    fs.mkdirSync('./dist/js');
    fs.writeFileSync('./src/style.min.css', '');
    done();
});         